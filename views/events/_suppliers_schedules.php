            ...
            <div class="mb-6">
                <div class="flex items-center justify-between mb-2">
                    <h3 class="font-bold text-lg text-blue-800">
                        ...
                        <span class="text-xs text-gray-500">(Proveedora)</span>
                    </h3>
                    <div class="flex gap-2">
                        <a href="<?= BASE_URL ?>/agendas/preview?event_id=<?= (int)($supplier['event_id'] ?? $event->getId() ?? 0) ?>&company_id=<?= (int)($supplier['company_id'] ?? 0) ?>" class="btn btn-info btn-xs" target="_blank">Ver Agenda</a>
                    </div>
                </div>
